...
All we need to do for this first homework assignment is organize the [Monthly Plan Enrollment Data](https://github.com/imccart/ma-class/blob/main/data-code/1_Plan_Data.R) and focus specifically on 2015. Note that these data are monthly, so you'll need to either select a given month of data to work with or combine all of the months and collapse to a single plan-county-year. Once you've created this dataset, answer the following:
